    ...
    >
      ...
      <template #footer>
        <view class="flex justify-between items-center px-[32rpx]">
          <view class="flex items-start flex-col text-[24rpx]">
            <pf-data-type :productType="product_type" :dataType="data_type"></pf-data-type>
            <view class="text-[#ccc] mt-[16rpx]">{{ success_count }} 笔需求对接成功</view>
          </view>
          <wd-img
            :width="32"
            :height="32"
